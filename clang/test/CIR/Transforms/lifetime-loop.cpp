...
// RUN: cir-tool %t.cir -cir-lifetime-check="history=invalid,null remarks=pset-invalid" -verify-diagnostics -o %t-out.cir
// RUN: %clang_cc1 -std=c++17 -triple x86_64-unknown-linux-gnu -fclangir-enable -fclangir-lifetime-check="history=invalid,null;remarks=pset-invalid" -clangir-verify-diagnostics -emit-cir %s -o %t.cir
// XFAIL: *
