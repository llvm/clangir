...
void test_mm_mask_storeu_epi64(void *__P, __mmask8 __U, __m128i __A) {
  ...
  // CIR: %{{.*}} = cir.llvm.intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<!s64i x 2>, !cir.ptr<!cir.vector<!s64i x 2>>, !u32i, !cir.vector<!cir.int<u, 1> x 2>)
...
void test_mm_mask_storeu_epi32(void *__P, __mmask8 __U, __m128i __A) {
  ...
  // CIR: %{{.*}} = cir.llvm.intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<!s32i x 4>, !cir.ptr<!cir.vector<!s32i x 4>>, !u32i, !cir.vector<!cir.int<u, 1> x 4>)
...
void test_mm_mask_storeu_pd(void *__P, __mmask8 __U, __m128d __A) {
  ...
  // CIR: %{{.*}} = cir.llvm.intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<!cir.double x 2>, !cir.ptr<!cir.vector<!cir.double x 2>>, !u32i, !cir.vector<!cir.int<u, 1> x 2>)
...
void test_mm_mask_storeu_ps(void *__P, __mmask8 __U, __m128 __A) {
  ...
  // CIR: %{{.*}} = cir.llvm.intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<!cir.float x 4>, !cir.ptr<!cir.vector<!cir.float x 4>>, !u32i, !cir.vector<!cir.int<u, 1> x 4>)
...
void test_mm256_mask_storeu_epi32(void *__P, __mmask8 __U, __m256i __A) {
  ...
  // CIR: %{{.*}} = cir.llvm.intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<!s32i x 8>, !cir.ptr<!cir.vector<!s32i x 8>>, !u32i, !cir.vector<!cir.int<u, 1> x 8>)
...
void test_mm256_mask_storeu_epi64(void *__P, __mmask8 __U, __m256i __A) {
  ...
  // CIR: %{{.*}} = cir.llvm.intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<!s64i x 4>, !cir.ptr<!cir.vector<!s64i x 4>>, !u32i, !cir.vector<!cir.int<u, 1> x 4>)
...
void test_mm256_mask_storeu_ps(void *__P, __mmask8 __U, __m256 __A) {
  ...
  // CIR: %{{.*}} = cir.llvm.intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<!cir.float x 8>, !cir.ptr<!cir.vector<!cir.float x 8>>, !u32i, !cir.vector<!cir.int<u, 1> x 8>) -> !void
