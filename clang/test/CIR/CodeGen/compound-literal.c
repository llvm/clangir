...
// CIR:    [[COMPLITERAL_MEM:%.*]] = cir.alloca !ty_anon2E1, !cir.ptr<!ty_anon2E1>, [".compoundliteral"] {alignment = 4 : i64}
// CIR:    [[FIELD:%.*]] = cir.get_member [[COMPLITERAL_MEM]][0] {name = "i"} : !cir.ptr<!ty_anon2E1> -> !cir.ptr<!s32i>
