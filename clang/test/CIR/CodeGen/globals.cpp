...
//      CHECK: cir.func dso_local @_Z10use_globalv()
...
//      CHECK: cir.func dso_local @_Z17use_global_stringv()
...
// CHECK-NEXT:  }
// CHECK-NEXT:  cir.func dso_local @_Z8use_funcv() -> !s32i
// CHECK-NEXT:    %0 = cir.alloca !s32i, !cir.ptr<!s32i>, ["__retval"] {alignment = 4 : i64}
...
void get_globals() {
  // CHECK: cir.func dso_local @_Z11get_globalsv()
  char *s = string;
...
// CHECK: cir.func dso_local @{{.+}}testExternVar
