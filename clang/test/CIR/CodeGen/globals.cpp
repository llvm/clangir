...
// CHECK-NEXT: cir.global "private" constant internal @".str" = #cir.cst_array<"example\00" : !cir.array<i8 x 8>> {alignment = 1 : i64}
// CHECK-NEXT: cir.global external @s = @".str": !cir.ptr<i8>

// CHECK-NEXT: cir.global "private" constant internal @".str1" = #cir.cst_array<"example1\00" : !cir.array<i8 x 9>> {alignment = 1 : i64}
