// RUN: %clang_cc1 -std=c++17 -triple x86_64-unknown-linux-gnu -mconstructor-aliases -fenable-clangir -emit-cir %s -o - | FileCheck %s
...
// CHECK-NEXT:     %0 = cir.alloca !cir.ptr<!22struct2EDummyString22>, cir.ptr <!cir.ptr<!22struct2EDummyString22>>, ["this", paraminit] {alignment = 8 : i64}
...
// CHECK-NEXT:     %0 = cir.alloca !22struct2EDummyString22, cir.ptr <!22struct2EDummyString22>, ["s4", uninitialized] {alignment = 1 : i64}
