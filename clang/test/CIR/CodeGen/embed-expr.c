...
// CIR: %[[ARRAY:.*]] = cir.get_global @__const.embed_expr_on_scalar_with_constants.a : !cir.ptr<!cir.array<!s32i x 3>>
// CIR: cir.copy %[[ARRAY]] to %[[A_ADDR]] : !cir.ptr<!cir.array<!s32i x 3>>

// LLVM: %[[A_ADDR:.*]] = alloca [3 x i32], i64 1, align 4
// LLVM: call void @llvm.memcpy.p0.p0.i64(ptr %[[A_ADDR]], ptr @__const.embed_expr_on_scalar_with_constants.a, i64 12, i1 false)
