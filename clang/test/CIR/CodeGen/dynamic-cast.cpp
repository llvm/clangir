...
// AFTER-NEXT:     %[[#RESULT:]] = cir.ternary(%[[#SRC_IS_NOT_NULL2]], true {
...
// AFTER-NEXT:     }, false {
// AFTER-NEXT:       %[[#NULL_PTR2:]] = cir.const #cir.ptr<null> : !cir.ptr<!void>
// AFTER-NEXT:       cir.yield %[[#NULL_PTR2]] : !cir.ptr<!void>
// AFTER-NEXT:     }) : (!cir.bool) -> !cir.ptr<!void>
// AFTER-NEXT:     cir.yield %[[#RESULT]] : !cir.ptr<!void>
// AFTER-NEXT:   }) : (!cir.bool) -> !cir.ptr<!void>
//      AFTER: }
