...
// CHECK-DAG: !ty_22Node22_1 = !cir.struct<struct "Node" {!cir.ptr<!ty_22Node22>} #cir.record.decl.ast>
...
// CHECK-DAG: cir.get_member {{%.}}[0] {name = "next"} : !cir.ptr<!ty_22Node22_1> -> !cir.ptr<!cir.ptr<!ty_22Node22_1>>
