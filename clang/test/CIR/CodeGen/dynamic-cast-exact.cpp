...
//      LLVM: define ptr @_Z8ptr_castP5Base1(ptr readonly captures(ret: address, provenance) %[[#SRC:]])
...
//      LLVM: define noundef ptr @_Z8ref_castR5Base1(ptr readonly returned captures(ret: address, provenance) %[[#SRC:]])
// LLVM-NEXT:   %[[#VPTR:]] = load ptr, ptr %[[#SRC]], align 8
...
//      LLVM: define noalias noundef ptr @_Z20ptr_cast_always_failP5Base2(ptr readnone captures(none) %{{.+}})
...
//      LLVM: define noalias noundef nonnull ptr @_Z20ref_cast_always_failR5Base2(ptr readnone captures(none) %{{.+}})
// LLVM-NEXT:   tail call void @__cxa_bad_cast()
// LLVM-NEXT:   unreachable
// LLVM-NEXT: }
