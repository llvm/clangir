...
// CIR: #tbaa[[PTR:.*]] = #cir.tbaa_scalar_type_desc<id = "any pointer">
// CIR: #tbaa[[INT:.*]] = #cir.tbaa_scalar_type_desc<id = "int">
// CIR: #tbaa[[SHORT:.*]] = #cir.tbaa_scalar_type_desc<id = "short">
// CIR: #tbaa[[CHAR:.*]] = #cir.tbaa_scalar_type_desc<id = "omnipotent char">
// CIR: #tbaa[[STRUCT_StructA:.*]] = #cir.tbaa_struct_type_desc<id = "_ZTS7StructA", members = {<#tbaa[[SHORT]], 0, 2>, <#tbaa[[INT]], 4, 4>, <#tbaa[[SHORT]], 8, 2>, <#tbaa[[INT]], 12, 4>}>
// CIR: #tbaa[[STRUCT_StructS:.*]] = #cir.tbaa_struct_type_desc<id = "_ZTS7StructS", members = {<#tbaa[[SHORT]], 0, 2>, <#tbaa[[INT]], 4, 4>}>
// CIR: #tbaa[[STRUCT_StructS2:.*]] = #cir.tbaa_struct_type_desc<id = "_ZTS8StructS2", members = {<#tbaa[[SHORT]], 0, 2>, <#tbaa[[INT]], 4, 4>}>
// CIR: #tbaa[[STRUCT_six:.*]] = #cir.tbaa_struct_type_desc<id = "_ZTS3six", members = {<#tbaa[[CHAR]], 0, 1>, <#tbaa[[CHAR]], 4, 1>, <#tbaa[[CHAR]], 5, 1>}>
// CIR: #tbaa[[TAG_StructA_f32:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructA]], access_type = #tbaa[[INT]], offset = 4, size = 4>
// CIR: #tbaa[[TAG_StructA_f16:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructA]], access_type = #tbaa[[SHORT]], offset = 0, size = 2>
// CIR: #tbaa[[TAG_StructS_f32:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructS]], access_type = #tbaa[[INT]], offset = 4, size = 4>
// CIR: #tbaa[[TAG_StructS_f16:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructS]], access_type = #tbaa[[SHORT]], offset = 0, size = 2>
// CIR: #tbaa[[TAG_StructS2_f32:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructS2]], access_type = #tbaa[[INT]], offset = 4, size = 4>
// CIR: #tbaa[[TAG_StructS2_f16:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructS2]], access_type = #tbaa[[SHORT]], offset = 0, size = 2>
// CIR: #tbaa[[TAG_six_b:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_six]], access_type = #tbaa[[CHAR]], offset = 4, size = 1>
// CIR: #tbaa[[STRUCT_StructB:.*]] = #cir.tbaa_struct_type_desc<id = "_ZTS7StructB", members = {<#tbaa[[SHORT]], 0, 2>, <#tbaa_struct_type_desc, 4, 16>, <#tbaa[[INT]], 20, 4>}>
// CIR: #tbaa[[TAG_StructB_a_f32:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructB]], access_type = #tbaa[[INT]], offset = 8, size = 4>
// CIR: #tbaa[[TAG_StructB_a_f16:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructB]], access_type = #tbaa[[SHORT]], offset = 4, size = 2>
// CIR: #tbaa[[TAG_StructB_f32:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructB]], access_type = #tbaa[[INT]], offset = 20, size = 4>
// CIR: #tbaa[[TAG_StructB_a_f32_2:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructB]], access_type = #tbaa[[INT]], offset = 16, size = 4>
// CIR: #tbaa[[STRUCT_StructC:.*]] = #cir.tbaa_struct_type_desc<id = "_ZTS7StructC", members = {<#tbaa[[SHORT]], 0, 2>, <#tbaa[[STRUCT_StructB]], 4, 24>, <#tbaa[[INT]], 28, 4>}>
// CIR: #tbaa[[STRUCT_StructD:.*]] = #cir.tbaa_struct_type_desc<id = "_ZTS7StructD", members = {<#tbaa[[SHORT]], 0, 2>, <#tbaa[[STRUCT_StructB]], 4, 24>, <#tbaa[[INT]], 28, 4>, <#tbaa[[CHAR]], 32, 1>}>
// CIR: #tbaa[[TAG_StructC_b_a_f32:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructC]], access_type = #tbaa[[INT]], offset = 12, size = 4>
// CIR: #tbaa[[TAG_StructD_b_a_f32:.*]] = #cir.tbaa_tag<base_type = #tbaa[[STRUCT_StructD]], access_type = #tbaa[[INT]], offset = 12, size = 4>
...
char g14(struct six *a, struct six *b) {
  ...
  // CIR: %[[TMP1:.*]] = cir.load %{{.*}} : !cir.ptr<!cir.ptr<!ty_six>>, !cir.ptr<!ty_six> tbaa([#tbaa[[PTR]]])
