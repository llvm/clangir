...
// CHECK:   %3 = cir.vtable.address_point(@_ZTV1B, address_point = (0, 2)) : !cir.ptr<!cir.ptr<!cir.func<() -> !u32i>>>
...
// CHECK:    %2 = cir.vtable.address_point(@_ZTV1A, address_point = (0, 2)) : !cir.ptr<!cir.ptr<!cir.func<() -> !u32i>>>
