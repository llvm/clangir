...
// CHECK:   %3 = cir.vtable.address_point(@_ZTV1B, address_point = <index = 0, offset = 2>) : !cir.ptr<!cir.vptr>
// CHECK:   %4 = cir.cast(bitcast, %1 : !cir.ptr<![[ClassB]]>), !cir.ptr<!cir.ptr<!cir.vptr>>
// CHECK:   cir.store{{.*}} %3, %4 : !cir.ptr<!cir.vptr>, !cir.ptr<!cir.ptr<!cir.vptr>>
// CHECK:   cir.return
// CHECK: }
...
// CHECK:    %2 = cir.vtable.address_point(@_ZTV1A, address_point = <index = 0, offset = 2>) : !cir.ptr<!cir.vptr>
// CHECK:    %3 = cir.cast(bitcast, %1 : !cir.ptr<![[ClassA]]>), !cir.ptr<!cir.ptr<!cir.vptr>>
// CHECK:    cir.store{{.*}} %2, %3 : !cir.ptr<!cir.vptr>, !cir.ptr<!cir.ptr<!cir.vptr>>
// CHECK:    cir.return
// CHECK:  }
