// RUN: %clang_cc1 -std=c++17 -triple x86_64-unknown-linux-gnu -fenable-clangir -emit-cir %s -o - | FileCheck %s
...
// CHECK-NEXT:   %3 = cir.cst(nullptr) : !cir.ptr<i8>
...
// CHECK-NEXT:   %0 = cir.alloca !cir.ptr<!22class2EString22>, cir.ptr <!cir.ptr<!22class2EString22>>, ["this", paraminit] {alignment = 8 : i64}
...
// CHECK-NEXT:   %4 = cir.cst(nullptr) : !cir.ptr<i8>
