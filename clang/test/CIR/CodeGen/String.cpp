...
// CHECK-NEXT:   %2 = "cir.struct_element_addr"(%0) <{member_name = "size"}> : (!cir.ptr<!cir.ptr<!22class2EString22>>) -> !cir.ptr<i64>
...
// CHECK-NEXT:   %3 = "cir.struct_element_addr"(%0) <{member_name = "size"}> : (!cir.ptr<!cir.ptr<!22class2EString22>>) -> !cir.ptr<i64>
