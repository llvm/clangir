...
// CHECK:   %18 = cir.call @_ZZ3go4vENK3$_0cvPFN5folly4coro4TaskIiEERKiEEv(%17) : (!cir.ptr<!ty_22class2Eanon22_1>) -> !cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
// CHECK:   %19 = cir.unary(plus, %18) : !cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>, !cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
// CHECK:   cir.yield %19 : !cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
// CHECK: }
// CHECK: cir.store %12, %3 : !cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>, cir.ptr <!cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>>
// CHECK: cir.scope {
// CHECK:   %17 = cir.alloca !s32i, cir.ptr <!s32i>, ["ref.tmp2", init] {alignment = 4 : i64}
// CHECK:   %18 = cir.load %3 : cir.ptr <!cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>>, !cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
...
// CHECK:   %20 = cir.call %18(%17) : (!cir.ptr<(!cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>, !cir.ptr<!s32i>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1
