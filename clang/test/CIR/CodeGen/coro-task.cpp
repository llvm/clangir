...
// CHECK:   %18 = cir.call @_ZZ3go4vENK3$_0cvPFN5folly4coro4TaskIiEERKiEEv(%17) : (!cir.ptr<!ty_22class2Eanon22_1>) -> !cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
// CHECK:   %19 = cir.unary(plus, %18) : !cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>, !cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
// CHECK:   cir.yield %19 : !cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
// CHECK: }
// CHECK: cir.store %12, %3 : !cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>, cir.ptr <!cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>>
// CHECK: cir.scope {
// CHECK:   %17 = cir.alloca i32, cir.ptr <i32>, ["ref.tmp2", init] {alignment = 4 : i64}
// CHECK:   %18 = cir.load %3 : cir.ptr <!cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>>, !cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>
// CHECK:   %19 = cir.const(3 : i32) : i32
// CHECK:   cir.store %19, %17 : i32, cir.ptr <i32>

// Call invoker, which calls operator() indirectly.
// CHECK:   %20 = cir.call %18(%17) : (!cir.ptr<(!cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1>, !cir.ptr<i32>) -> !ty_22struct2Efolly3A3Acoro3A3ATask22_1
