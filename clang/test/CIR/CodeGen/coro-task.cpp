...
// CHECK: %12 = cir.scope {
// CHECK:   %17 = cir.alloca !ty_22anon22_1, cir.ptr <!ty_22anon22_1>, ["ref.tmp1"] {alignment = 1 : i64}

// Get the lambda invoker ptr via `lambda operator folly::coro::Task<int> (*)(int const&)()`
// CHECK:   %18 = cir.call @_ZZ3go4vENK3$_0cvPFN5folly4coro4TaskIiEERKiEEv(%17) : (!cir.ptr<!ty_22anon22_1>) -> !cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>
// CHECK:   %19 = cir.unary(plus, %18) : !cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>, !cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>
// CHECK:   cir.yield %19 : !cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>
// CHECK: }
// CHECK: cir.store %12, %3 : !cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>, cir.ptr <!cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>>
// CHECK: cir.scope {
// CHECK:   %17 = cir.alloca !s32i, cir.ptr <!s32i>, ["ref.tmp2", init] {alignment = 4 : i64}
// CHECK:   %18 = cir.load %3 : cir.ptr <!cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>>, !cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>
...
// CHECK:   %20 = cir.call %18(%17) : (!cir.ptr<!cir.func<!ty_22folly3A3Acoro3A3ATask22_1 (!cir.ptr<!s32i>)>>, !cir.ptr<!s32i>) -> !ty_22folly3A3Acoro3A3ATask22_1
// CHECK:   cir.store %20, %4 : !ty_22folly3A3Acoro3A3ATask22_1, cir.ptr <!ty_22folly3A3Acoro3A3ATask22_1>
// CHECK: }
