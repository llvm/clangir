...
// CHECK: %12 = cir.scope {
// CHECK:   %17 = cir.alloca !ty_anon2E5, !cir.ptr<!ty_anon2E5>, ["ref.tmp1"] {alignment = 1 : i64}

// Get the lambda invoker ptr via `lambda operator folly::coro::Task<int> (*)(int const&)()`
// CHECK:   %18 = cir.call @_ZZ3go4vENK3$_0cvPFN5folly4coro4TaskIiEERKiEEv(%17) : (!cir.ptr<!ty_anon2E5>) -> !cir.ptr<!cir.func<![[IntTask]] (!cir.ptr<!s32i>)>>
