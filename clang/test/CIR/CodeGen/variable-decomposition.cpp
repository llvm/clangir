...
// CIR:  %[[CONST:.+]] = cir.get_global @__const._Z8functionv. : !cir.ptr<!rec_some_struct>
// CIR:  cir.copy %[[CONST]] to %[[STRUCT]] : !cir.ptr<!rec_some_struct>
...
// LLVM:  call void @llvm.memcpy.p0.p0.i64(ptr %[[STRUCT]], ptr @__const._Z8functionv., i64 8, i1 false)
