...
// CHECK-LABEL: cir.func dso_local @_Z16make_non_virtualv() -> !cir.method<!cir.func<(!s32i)> in !rec_Foo>
...
// CHECK-LABEL: cir.func dso_local @_Z12make_virtualv() -> !cir.method<!cir.func<(!s32i)> in !rec_Foo>
...
// CHECK-LABEL: cir.func dso_local @_Z9make_nullv() -> !cir.method<!cir.func<(!s32i)> in !rec_Foo>
...
// CHECK-LABEL: cir.func dso_local @_Z4callP3FooMS_FviEi
