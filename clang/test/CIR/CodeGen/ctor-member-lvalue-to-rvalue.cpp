// RUN: %clang_cc1 -std=c++17 -mconstructor-aliases -triple x86_64-unknown-linux-gnu -fenable-clangir -emit-cir %s -o - | FileCheck %s
...
// CHECK:     %0 = cir.alloca !cir.ptr<!22struct2EString22>, cir.ptr <!cir.ptr<!22struct2EString22>>, ["this", paraminit] {alignment = 8 : i64}
...
void foo() {
  ...
  //  cir.func @_Z3foov() {
  //   %0 = cir.alloca !22struct2EString22, cir.ptr <!22struct2EString22>, ["s", uninitialized] {alignment = 8 : i64}
  //   %1 = cir.alloca !22struct2EString22, cir.ptr <!22struct2EString22>, ["s1", uninitialized] {alignment = 8 : i64}
