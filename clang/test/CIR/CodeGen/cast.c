...
// CHECK:    cir.scope {
// CHECK:      [[TMP:%.*]] = cir.alloca !ty_22A22, !cir.ptr<!ty_22A22>, ["ref.tmp0"] {alignment = 4 : i64}
// CHECK:      cir.copy [[ALLOC_A]] to [[TMP]] : !cir.ptr<!ty_22A22>
// CHECK:      [[X_ADDR:%.*]] = cir.get_member [[TMP]][0] {name = "x"} : !cir.ptr<!ty_22A22> -> !cir.ptr<!s32i>
