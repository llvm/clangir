// RUN: %clang_cc1 -triple x86_64-unknown-linux-gnu -Wno-unused-value -fclangir-enable -emit-cir %s -o - | FileCheck %s
...
// CHECK-NEXT: %4 = cir.const(#cir.float<0.000000e+00> : !cir.double) : !cir.double
// CHECK-NEXT: cir.store %4, %1 : !cir.double, cir.ptr <!cir.double>
// CHECK-NEXT: %5 = cir.const(#cir.float<0.000000e+00> : !cir.float) : !cir.float
