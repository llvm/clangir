...
// CHECK: %0 = cir.alloca !cir.ptr<!ty_22class2Eanon22_1>, cir.ptr <!cir.ptr<!ty_22class2Eanon22_1>>, ["this", init]
// CHECK: %1 = cir.load %0 : cir.ptr <!cir.ptr<!ty_22class2Eanon22_1>>, !cir.ptr<!ty_22class2Eanon22_1>
// CHECK: %2 = "cir.struct_element_addr"(%1) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_1>) -> !cir.ptr<!cir.ptr<i32>>
...
// CHECK: %7 = "cir.struct_element_addr"(%1) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_1>) -> !cir.ptr<!cir.ptr<i32>>
...
// CHECK: cir.func @_Z1gv() -> !ty_22class2Eanon22_2 {
// CHECK: %0 = cir.alloca !ty_22class2Eanon22_2, cir.ptr <!ty_22class2Eanon22_2>, ["__retval"] {alignment = 8 : i64}
// CHECK: %1 = cir.alloca i32, cir.ptr <i32>, ["i", init] {alignment = 4 : i64}
// CHECK: %2 = cir.const(12 : i32) : i32
// CHECK: cir.store %2, %1 : i32, cir.ptr <i32>
// CHECK: %3 = "cir.struct_element_addr"(%0) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_2>) -> !cir.ptr<!cir.ptr<i32>>
// CHECK: cir.store %1, %3 : !cir.ptr<i32>, cir.ptr <!cir.ptr<i32>>
// CHECK: %4 = cir.load %0 : cir.ptr <!ty_22class2Eanon22_2>, !ty_22class2Eanon22_2
// CHECK: cir.return %4 : !ty_22class2Eanon22_2
...
// CHECK: cir.func @_Z2g2v() -> !ty_22class2Eanon22_3 {
// CHECK-NEXT: %0 = cir.alloca !ty_22class2Eanon22_3, cir.ptr <!ty_22class2Eanon22_3>, ["__retval", init] {alignment = 8 : i64}
...
// CHECK-NEXT: %3 = "cir.struct_element_addr"(%0) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_3>) -> !cir.ptr<!cir.ptr<i32>>
// CHECK-NEXT: cir.store %1, %3 : !cir.ptr<i32>, cir.ptr <!cir.ptr<i32>>
// CHECK-NEXT: %4 = cir.load %0 : cir.ptr <!ty_22class2Eanon22_3>, !ty_22class2Eanon22_3
// CHECK-NEXT: cir.return %4 : !ty_22class2Eanon22_3
...
// CHECK-NEXT:     %2 = cir.alloca !ty_22class2Eanon22_3, cir.ptr <!ty_22class2Eanon22_3>, ["ref.tmp0"] {alignment = 8 : i64}
// CHECK-NEXT:     %3 = cir.call @_Z2g2v() : () -> !ty_22class2Eanon22_3
// CHECK-NEXT:     cir.store %3, %2 : !ty_22class2Eanon22_3, cir.ptr <!ty_22class2Eanon22_3>
// CHECK-NEXT:     %4 = cir.call @_ZZ2g2vENK3$_0clEv(%2) : (!cir.ptr<!ty_22class2Eanon22_3>) -> i32
...
// CHECK:     %3 = cir.scope {
// CHECK:       %7 = cir.alloca !ty_22class2Eanon22_4, cir.ptr <!ty_22class2Eanon22_4>, ["ref.tmp0"] {alignment = 1 : i64}
// CHECK:       %8 = cir.call @_ZZ2g3vENK3$_0cvPFiRKiEEv(%7) : (!cir.ptr<!ty_22class2Eanon22_4>) -> !cir.ptr<(!cir.ptr<i32>) -> i32>
