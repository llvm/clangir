...
//      CHECK: cir.func lambda internal private dso_local nothrow @_ZZ2fnvENK3$_0clEv{{.*}})
...
// CHECK: cir.func lambda internal private dso_local nothrow @_ZZ2l0vENK3$_0clEv({{.*}})
...
// lambda operator()
// CHECK: cir.func lambda internal private dso_local nothrow @_ZZ2g3vENK3$_0clERKi{{.*}}

// lambda __invoke()
// CHECK:   cir.func internal private dso_local nothrow @_ZZ2g3vEN3$_08__invokeERKi

// lambda operator int (*)(int const&)()
// CHECK:   cir.func internal private dso_local nothrow @_ZZ2g3vENK3$_0cvPFiRKiEEv
