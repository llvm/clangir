...
// CHECK: %2 = "cir.struct_element_addr"(%1) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_2>) -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: %7 = "cir.struct_element_addr"(%1) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_2>) -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: %3 = "cir.struct_element_addr"(%0) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_3>) -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK-NEXT: %3 = "cir.struct_element_addr"(%0) <{member_name = "i"}> : (!cir.ptr<!ty_22class2Eanon22_4>) -> !cir.ptr<!cir.ptr<!s32i>>
