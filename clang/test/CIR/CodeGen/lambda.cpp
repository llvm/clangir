...
// CHECK: %0 = cir.alloca !cir.ptr<!ty_22anon22_2>, cir.ptr <!cir.ptr<!ty_22anon22_2>>, ["this", init] {alignment = 8 : i64}
// CHECK: cir.store %arg0, %0 : !cir.ptr<!ty_22anon22_2>, cir.ptr <!cir.ptr<!ty_22anon22_2>>
// CHECK: %1 = cir.load %0 : cir.ptr <!cir.ptr<!ty_22anon22_2>>, !cir.ptr<!ty_22anon22_2>
// CHECK: %2 = "cir.struct_element_addr"(%1) <{member_index = 0 : index, member_name = "i"}> : (!cir.ptr<!ty_22anon22_2>) -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: %7 = "cir.struct_element_addr"(%1) <{member_index = 0 : index, member_name = "i"}> : (!cir.ptr<!ty_22anon22_2>) -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: cir.func @_Z1gv() -> !ty_22anon22_3
// CHECK: %0 = cir.alloca !ty_22anon22_3, cir.ptr <!ty_22anon22_3>, ["__retval"] {alignment = 8 : i64}
...
// CHECK: %3 = "cir.struct_element_addr"(%0) <{member_index = 0 : index, member_name = "i"}> : (!cir.ptr<!ty_22anon22_3>) -> !cir.ptr<!cir.ptr<!s32i>>
// CHECK: cir.store %1, %3 : !cir.ptr<!s32i>, cir.ptr <!cir.ptr<!s32i>>
// CHECK: %4 = cir.load %0 : cir.ptr <!ty_22anon22_3>, !ty_22anon22_3
// CHECK: cir.return %4 : !ty_22anon22_3
...
// CHECK: cir.func @_Z2g2v() -> !ty_22anon22_4
// CHECK-NEXT: %0 = cir.alloca !ty_22anon22_4, cir.ptr <!ty_22anon22_4>, ["__retval", init] {alignment = 8 : i64}
...
// CHECK-NEXT: %3 = "cir.struct_element_addr"(%0) <{member_index = 0 : index, member_name = "i"}> : (!cir.ptr<!ty_22anon22_4>) -> !cir.ptr<!cir.ptr<!s32i>>
// CHECK-NEXT: cir.store %1, %3 : !cir.ptr<!s32i>, cir.ptr <!cir.ptr<!s32i>>
// CHECK-NEXT: %4 = cir.load %0 : cir.ptr <!ty_22anon22_4>, !ty_22anon22_4
// CHECK-NEXT: cir.return %4 : !ty_22anon22_4
...
// CHECK-NEXT:     %2 = cir.alloca !ty_22anon22_4, cir.ptr <!ty_22anon22_4>, ["ref.tmp0"] {alignment = 8 : i64}
// CHECK-NEXT:     %3 = cir.call @_Z2g2v() : () -> !ty_22anon22_4
// CHECK-NEXT:     cir.store %3, %2 : !ty_22anon22_4, cir.ptr <!ty_22anon22_4>
// CHECK-NEXT:     %4 = cir.call @_ZZ2g2vENK3$_0clEv(%2) : (!cir.ptr<!ty_22anon22_4>) -> !s32i
...
// CHECK:     %3 = cir.scope {
// CHECK:       %7 = cir.alloca !ty_22anon22_1, cir.ptr <!ty_22anon22_1>, ["ref.tmp0"] {alignment = 1 : i64}
// CHECK:       %8 = cir.call @_ZZ2g3vENK3$_0cvPFiRKiEEv(%7) : (!cir.ptr<!ty_22anon22_1>) -> !cir.ptr<!cir.func<!s32i (!cir.ptr<!s32i>)>>
