...
//      CHECK: !ty_anon2E2 = !cir.struct<class "anon.2" {!u8i}>
//  CHECK-DAG: module

//      CHECK: cir.func lambda internal private @_ZZ2fnvENK3$_0clEv{{.*}}) extra

//      CHECK:   cir.func @_Z2fnv()
// CHECK-NEXT:     %0 = cir.alloca !ty_anon2E2, !cir.ptr<!ty_anon2E2>, ["a"]
...
// CHECK: %0 = cir.alloca !cir.ptr<!ty_anon2E4>, !cir.ptr<!cir.ptr<!ty_anon2E4>>, ["this", init] {alignment = 8 : i64}
// CHECK: cir.store %arg0, %0 : !cir.ptr<!ty_anon2E4>, !cir.ptr<!cir.ptr<!ty_anon2E4>>
// CHECK: %1 = cir.load %0 : !cir.ptr<!cir.ptr<!ty_anon2E4>>, !cir.ptr<!ty_anon2E4>
// CHECK: %2 = cir.get_member %1[0] {name = "i"} : !cir.ptr<!ty_anon2E4> -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: %7 = cir.get_member %1[0] {name = "i"} : !cir.ptr<!ty_anon2E4> -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: cir.func @_Z1gv() -> !ty_anon2E6
// CHECK: %0 = cir.alloca !ty_anon2E6, !cir.ptr<!ty_anon2E6>, ["__retval"] {alignment = 8 : i64}
...
// CHECK: %3 = cir.get_member %0[0] {name = "i"} : !cir.ptr<!ty_anon2E6> -> !cir.ptr<!cir.ptr<!s32i>>
// CHECK: cir.store %1, %3 : !cir.ptr<!s32i>, !cir.ptr<!cir.ptr<!s32i>>
// CHECK: %4 = cir.load %0 : !cir.ptr<!ty_anon2E6>, !ty_anon2E6
// CHECK: cir.return %4 : !ty_anon2E6
...
// CHECK: cir.func @_Z2g2v() -> !ty_anon2E8
// CHECK-NEXT: %0 = cir.alloca !ty_anon2E8, !cir.ptr<!ty_anon2E8>, ["__retval", init] {alignment = 8 : i64}
...
// CHECK-NEXT: %3 = cir.get_member %0[0] {name = "i"} : !cir.ptr<!ty_anon2E8> -> !cir.ptr<!cir.ptr<!s32i>>
// CHECK-NEXT: cir.store %1, %3 : !cir.ptr<!s32i>, !cir.ptr<!cir.ptr<!s32i>>
// CHECK-NEXT: %4 = cir.load %0 : !cir.ptr<!ty_anon2E8>, !ty_anon2E8
// CHECK-NEXT: cir.return %4 : !ty_anon2E8
...
// CHECK-NEXT:     %2 = cir.alloca !ty_anon2E8, !cir.ptr<!ty_anon2E8>, ["ref.tmp0"] {alignment = 8 : i64}
// CHECK-NEXT:     %3 = cir.call @_Z2g2v() : () -> !ty_anon2E8
// CHECK-NEXT:     cir.store %3, %2 : !ty_anon2E8, !cir.ptr<!ty_anon2E8>
// CHECK-NEXT:     %4 = cir.call @_ZZ2g2vENK3$_0clEv(%2) : (!cir.ptr<!ty_anon2E8>) -> !s32i
...
// CHECK:     %3 = cir.scope {
// CHECK:       %7 = cir.alloca !ty_anon2E11, !cir.ptr<!ty_anon2E11>, ["ref.tmp0"] {alignment = 1 : i64}
// CHECK:       %8 = cir.call @_ZZ2g3vENK3$_0cvPFiRKiEEv(%7) : (!cir.ptr<!ty_anon2E11>) -> !cir.ptr<!cir.func<!s32i (!cir.ptr<!s32i>)>>
