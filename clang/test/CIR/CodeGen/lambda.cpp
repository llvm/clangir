...
// CHECK: %2 = cir.get_member %1[0] {name = "i"} : !cir.ptr<!ty_22anon22_2> -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: %7 = cir.get_member %1[0] {name = "i"} : !cir.ptr<!ty_22anon22_2> -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK: %3 = cir.get_member %0[0] {name = "i"} : !cir.ptr<!ty_22anon22_3> -> !cir.ptr<!cir.ptr<!s32i>>
...
// CHECK-NEXT: %3 = cir.get_member %0[0] {name = "i"} : !cir.ptr<!ty_22anon22_4> -> !cir.ptr<!cir.ptr<!s32i>>
