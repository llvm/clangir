...
// CHECK-NEXT:   %2 = cir.alloca !22struct2EFoo22, cir.ptr <!22struct2EFoo22>, ["f", uninitialized] {alignment = 4 : i64}
// CHECK-NEXT:   call @_ZN3Bar6methodEv(%0) : (!cir.ptr<!22struct2EBar22>) -> ()
// CHECK-NEXT:   %3 = cir.cst(4 : i32) : i32
// CHECK-NEXT:   call @_ZN3Bar7method2Ei(%0, %3) : (!cir.ptr<!22struct2EBar22>, i32) -> ()
// CHECK-NEXT:   %4 = cir.cst(4 : i32) : i32
// CHECK-NEXT:   %5 = call @_ZN3Bar7method3Ei(%0, %4) : (!cir.ptr<!22struct2EBar22>, i32) -> i32
// CHECK-NEXT:   cir.store %5, %1 : i32, cir.ptr <i32>
// CHECK-NEXT:   cir.return
// CHECK-NEXT: }
//      CHECK: func @_ZN3Bar6methodEv(%arg0: !cir.ptr<!22struct2EBar22>
// CHECK-NEXT:   %0 = cir.alloca !cir.ptr<!22struct2EBar22>, cir.ptr <!cir.ptr<!22struct2EBar22>>, ["this", paraminit] {alignment = 8 : i64}
...
// CHECK-NEXT:   cir.return
// CHECK-NEXT: }
//      CHECK: func @_ZN3Bar7method2Ei(%arg0: !cir.ptr<!22struct2EBar22> {{.*}}, %arg1: i32
// CHECK-NEXT:   %0 = cir.alloca !cir.ptr<!22struct2EBar22>, cir.ptr <!cir.ptr<!22struct2EBar22>>, ["this", paraminit] {alignment = 8 : i64}
...
// CHECK-NEXT:   cir.return
// CHECK-NEXT: }
//      CHECK: func @_ZN3Bar7method3Ei(%arg0: !cir.ptr<!22struct2EBar22> {{.*}}, %arg1: i32
// CHECK-NEXT:   %0 = cir.alloca !cir.ptr<!22struct2EBar22>, cir.ptr <!cir.ptr<!22struct2EBar22>>, ["this", paraminit] {alignment = 8 : i64}
// CHECK-NEXT:   %1 = cir.alloca i32, cir.ptr <i32>, ["a", paraminit] {alignment = 4 : i64}
