...
// CHECK-DAG: !ty_anon2E5 = !cir.struct<struct "anon.5" {!cir.bool, !s32i} #cir.record.decl.ast>
// CHECK-DAG: !ty_anon2E1 = !cir.struct<struct "anon.1" {!s32i} #cir.record.decl.ast>
// CHECK-DAG: !ty_yolo = !cir.struct<struct "yolo" {!s32i} #cir.record.decl.ast>
// CHECK-DAG: !ty_anon2E3 = !cir.struct<struct "anon.3" {!cir.ptr<!s32i>, !s32i} #cir.record.decl.ast>

// CHECK-DAG: !ty_yolm = !cir.struct<union "yolm" {!ty_yolo, !ty_anon2E1}>
// CHECK-DAG: !ty_yolm3 = !cir.struct<union "yolm3" {!ty_yolo, !ty_anon2E5}>
// CHECK-DAG: !ty_yolm2 = !cir.struct<union "yolm2" {!ty_yolo, !ty_anon2E3}>
