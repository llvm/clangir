...
// CHECK: @__const._Z5func7v.arr = private constant [1 x ptr] zeroinitializer
// CHECK: @__const._Z5func5v.arr = private constant [2 x [1 x i32]] {{.*}}[1 x i32] [i32 5], [1 x i32] zeroinitializer{{.*}}
// CHECK: @__const._Z5func4v.arr = private constant [2 x [1 x i32]] {{.*}}[1 x i32] [i32 5], [1 x i32] [i32 6]{{.*}}
// CHECK: @__const._Z5func3v.arr3 = private constant [2 x i32] [i32 5, i32 6]
// CHECK: @__const._Z5func2v.arr = private constant [2 x i32] [i32 5, i32 0]
...
// CHECK:   call void @llvm.memcpy.p0.p0.i64(ptr %[[ARR]], ptr @__const._Z5func2v.arr, i64 8, i1 false)
// CHECK:   ret void
...
// CHECK:  call void @llvm.memcpy.p0.p0.i64(ptr %[[ARR_ALLOCA]], ptr @__const._Z5func3v.arr3, i64 8, i1 false)
...
// CHECK:  call void @llvm.memcpy.p0.p0.i64(ptr %[[ARR_ALLOCA]], ptr @__const._Z5func4v.arr, i64 8, i1 false)
...
// CHECK:   call void @llvm.memcpy.p0.p0.i64(ptr %[[ARR]], ptr @__const._Z5func5v.arr, i64 8, i1 false)
// CHECK:   ret void
...
// CHECK:   call void @llvm.memcpy.p0.p0.i64(ptr %[[ARR]], ptr @__const._Z5func7v.arr, i64 8, i1 false)
// CHECK:   ret void
