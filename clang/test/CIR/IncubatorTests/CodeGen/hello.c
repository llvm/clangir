...
// CHECK:   %1 = cir.get_global @".str" : !cir.ptr<!cir.array<!s8i x 15>>
// CHECK:   %2 = cir.cast array_to_ptrdecay %1 : !cir.ptr<!cir.array<!s8i x 15>> -> !cir.ptr<!s8i>
// CHECK:   %3 = cir.call @printf(%2) : (!cir.ptr<!s8i>) -> !s32i
// CHECK:   %4 = cir.const #cir.int<0> : !s32i
// CHECK:   cir.store %4, %0 : !s32i, !cir.ptr<!s32i>
// CHECK:   %5 = cir.load %0 : !cir.ptr<!s32i>, !s32i
// CHECK:   cir.return %5 : !s32i
// CHECK: }
