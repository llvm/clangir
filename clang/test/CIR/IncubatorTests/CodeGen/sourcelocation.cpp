...
// CIR:     %3 = cir.alloca !s32i, !cir.ptr<!s32i>, ["x", init] {alignment = 4 : i64} loc(#loc24)
...
// CIR:     %6 = cir.binop(add, %4, %5) nsw : !s32i loc(#loc25)
// CIR:     cir.store{{.*}} %6, %3 : !s32i, !cir.ptr<!s32i> loc(#loc24)
// CIR:     cir.scope {
// CIR:       %9 = cir.load{{.*}} %3 : !cir.ptr<!s32i>, !s32i loc(#loc13)
// CIR:       %10 = cir.const #cir.int<0> : !s32i loc(#loc14)
// CIR:       %11 = cir.cmp(gt, %9, %10) : !s32i, !cir.bool loc(#loc15)
// CIR:       cir.if %11 {
// CIR:         %12 = cir.const #cir.int<0> : !s32i loc(#loc17)
...
// CIR:       } loc(#loc27)
// CIR:     } loc(#loc26)
// CIR:     %7 = cir.load{{.*}} %3 : !cir.ptr<!s32i>, !s32i loc(#loc19)
...
// CIR: #loc15 = loc("{{.*}}sourcelocation.cpp":8:9)
// CIR: #loc16 = loc("{{.*}}sourcelocation.cpp":9:5)
// CIR: #loc17 = loc("{{.*}}sourcelocation.cpp":9:9)
...
// CIR: #loc27 = loc(fused[#loc16, #loc17, #loc18, #loc12])
// CIR: #loc28 = loc(fused[#loc16, #loc17])
// CIR: #loc29 = loc(fused[#loc18, #loc12])
// CIR: #loc30 = loc(fused[#loc20, #loc19])
