...
// CHECK:  cir.func {{.*}} @cstyle_cast_lvalue(%arg0: !u32i loc({{.*}}))
// CHECK:    [[ALLOC_A:%.*]] = cir.alloca !rec_A, !cir.ptr<!rec_A>, [""] {alignment = 4 : i64}
// CHECK:    [[CAST_A:%.*]] = cir.cast bitcast [[ALLOC_A]] : !cir.ptr<!rec_A> -> !cir.ptr<!u32i>
// CHECK:    cir.store %arg0, [[CAST_A]] : !u32i, !cir.ptr<!u32i>
