...
// CIR:  %[[VAL_7:.*]] = cir.ptr_stride inbounds %[[VAL_5]], %[[VAL_6]] : (!cir.ptr<!s8i>, !s32i) -> !cir.ptr<!s8i>
// CIR:  %[[VAL_8:.*]] = cir.cast bitcast %[[VAL_7]] : !cir.ptr<!s8i> -> !cir.ptr<!void>
// CIR:  cir.call_llvm_intrinsic "clear_cache" %[[VAL_3]], %[[VAL_8]] : (!cir.ptr<!void>, !cir.ptr<!void>) -> ()
