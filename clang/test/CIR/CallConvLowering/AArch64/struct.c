...
// CIR: %[[#V0:]] = cir.alloca !ty_S2, !cir.ptr<!ty_S2>, [""] {alignment = 4 : i64}
// CIR: %[[#V1:]] = cir.cast(bitcast, %[[#V0]] : !cir.ptr<!ty_S2>), !cir.ptr<!u16i>
// CIR: cir.store %arg0, %[[#V1]] : !u16i, !cir.ptr<!u16i>
// CIR: %[[#V2:]] = cir.alloca !ty_S2, !cir.ptr<!ty_S2>, ["__retval"] {alignment = 1 : i64}
// CIR: %[[#V3:]] = cir.const #cir.int<1> : !s32i
// CIR: %[[#V4:]] = cir.cast(integral, %[[#V3]] : !s32i), !s8i
// CIR: %[[#V5:]] = cir.get_member %[[#V0]][0] {name = "a"} : !cir.ptr<!ty_S2> -> !cir.ptr<!s8i>
// CIR: cir.store %[[#V4]], %[[#V5]] : !s8i, !cir.ptr<!s8i>
// CIR: %[[#V6:]] = cir.const #cir.int<2> : !s32i
// CIR: %[[#V7:]] = cir.cast(integral, %[[#V6]] : !s32i), !s8i
// CIR: %[[#V8:]] = cir.get_member %[[#V0]][1] {name = "b"} : !cir.ptr<!ty_S2> -> !cir.ptr<!s8i>
// CIR: cir.store %[[#V7]], %[[#V8]] : !s8i, !cir.ptr<!s8i>
// CIR: cir.copy %[[#V0]] to %[[#V2]] : !cir.ptr<!ty_S2>
// CIR: %[[#V9:]] = cir.cast(bitcast, %[[#V2]] : !cir.ptr<!ty_S2>), !cir.ptr<!u16i>
...
// CIR: %[[#V5:]] = cir.cast(bitcast, %[[#V1]] : !cir.ptr<!ty_S2>), !cir.ptr<!u16i>
// CIR: cir.store %[[#V4]], %[[#V5]] : !u16i, !cir.ptr<!u16i>
// CIR: cir.copy %[[#V1]] to %[[#V0]] : !cir.ptr<!ty_S2>
// CIR: cir.return
