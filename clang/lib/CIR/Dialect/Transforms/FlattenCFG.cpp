    ...
    for (auto caseOp : cases) {
      ...
      case mlir::cir::CaseOpKind::Range:
        ...
        rangeValues.push_back(
            {llvm::cast<mlir::cir::IntAttr>(caseOp.getValue()[0]).getValue(),
             llvm::cast<mlir::cir::IntAttr>(caseOp.getValue()[1]).getValue()});
      ...
      case mlir::cir::CaseOpKind::Equal:
        ...
        for (auto &value : caseOp.getValue()) {
          caseValues.push_back(llvm::cast<mlir::cir::IntAttr>(value).getValue());
