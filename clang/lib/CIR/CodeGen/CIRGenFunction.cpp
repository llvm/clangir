...
void CIRGenFunction::buildKernelMetadata(const FunctionDecl *FD,
  ...
  if (const VecTypeHintAttr *A = FD->getAttr<VecTypeHintAttr>()) {
    vecTypeHintAttr =
        mlir::TypeAttr::get(getTypes().ConvertType(A->getTypeHint()));
  }
  ...
  auto kernelMetadataAttr = mlir::cir::OpenCLKernelMetadataAttr::get(
      builder.getContext(), workGroupSizeHintAttr, reqdWorkGroupSizeAttr,
      vecTypeHintAttr, intelReqdSubGroupSizeAttr);
