...
public:
  ...
  matchAndRewrite(mlir::cir::ConstantOp op, OpAdaptor adaptor,
    ...
    // TODO(cir): constant array are currently just pushed into using the store instruction, intead of being stored as global variables and them memcopyied into the stack (as done in Clang).
