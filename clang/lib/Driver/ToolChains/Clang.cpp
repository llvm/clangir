...
void Clang::ConstructJob(Compilation &C, const JobAction &JA,
  ...
  if (!isa<AssembleJobAction>(JA)) {
    llvm::errs() << "This is a Assemble Job Action\n";
  ...
  if (isa<AnalyzeJobAction>(JA)) {
    llvm::errs() << "This is a AnalyzeJob Action\n";
    assert(JA.getType() == types::TY_Plist && "Invalid output type.");
    CmdArgs.push_back("-analyze");
  } else if (isa<PreprocessJobAction>(JA)) {
    llvm::errs() << "This is a PreprocessJobAction\n";
    ...
    llvm::errs() << "This is a AssembleJobAction\n";
    ...
    llvm::errs() << "This is a PrecompileJobAction\n";
    ...
    llvm::errs() << "Here accessing CompileJobAction and or BackEndJobAction\n";
    if (JA.getType() == types::TY_Nothing) {
      CmdArgs.push_back("-fsyntax-only");
