...
public:
  ...
  mlir::cir::StoreOp createStore(mlir::Location loc, mlir::Value val,
    ...
    if (llvm::cast<mlir::cir::PointerType>(dst.getType()).getPointee() !=
        val.getType())
  ...
  mlir::Value createGetMemberOp(mlir::Location &loc, mlir::Value structPtr,
    ...
    assert(llvm::isa<mlir::cir::PointerType>(structPtr.getType()));
    auto structBaseTy =
        llvm::cast<mlir::cir::PointerType>(structPtr.getType()).getPointee();
    assert(llvm::isa<mlir::cir::StructType>(structBaseTy));
    auto fldTy = llvm::cast<mlir::cir::StructType>(structBaseTy).getMembers()[idx];
  ...
  mlir::Value createZExtOrBitCast(mlir::Location loc, mlir::Value src,
    ...
    if (mlir::isa<mlir::cir::BoolType>(srcTy) && mlir::isa<mlir::cir::IntType>(newTy))
  ...
  mlir::Value createPtrBitcast(mlir::Value src, mlir::Type newPointeeTy) {
    assert(mlir::isa<mlir::cir::PointerType>(src.getType()) && "expected ptr src");
  ...
  mlir::TypedAttr getConstPtrAttr(mlir::Type t, int64_t v) {
    ...
    return mlir::cir::ConstPtrAttr::get(getContext(),
                                        llvm::cast<mlir::cir::PointerType>(t), val);
  }
